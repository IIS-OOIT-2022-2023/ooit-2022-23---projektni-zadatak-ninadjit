...
public class FrmDrawing extends JFrame {
	...
	private PnlDrawing pnlDrawing = new PnlDrawing(this); //this - menjanje moda rada aplikacije
	private JToggleButton tglbtnPoint = new JToggleButton("Point"); //obelezija napravljena da bi im panel pristupio pomocu set i get metoda
	 ...
	 */
	public FrmDrawing() {
		setTitle("Nikolina Đukić IT42/2022");
		...
		pnlNorth.setBackground(new Color(199, 252, 252));
		...
		pnlSouth.setBackground(new Color(13, 225, 225));
	...
	protected void delete() {
		...
		pnlDrawing.setSelectedShape(null);
		pnlDrawing.repaint();		//azurira crtez
	}
	...
	protected void modify() {
		...
		if (selectedShape != null) {
			...
			if (selectedShape instanceof Point) {
				...
				dialogd.getBtnInnerColor().setBackground(donut.getInnerColor());    //setujemo nove vrednosti
				dialogd.getBtnOutlineColor().setBackground(donut.getColor());
				dialogd.setModal(true);
				dialogd.setVisible(true);

				if (dialogd.isConfirm()) {
					pnlDrawing.getShapes().remove(selectedShape); //brise iz liste taj objekat
					pnlDrawing.getShapes().add(dialogd.getDonut()); //i dodaje taj novi objekat
					repaint();
				}
