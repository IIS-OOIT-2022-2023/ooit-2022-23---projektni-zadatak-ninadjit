...
public class PnlDrawing extends JPanel {
	...
	private FrmDrawing frame; //referenca koja detektuje koje dugme je utisnuto
	private ArrayList<Shape> shapes = new ArrayList<Shape>();
	private Point startPoint;
	private Shape selectedShape; //referencira trenutni selektovani objekat
	...
	public PnlDrawing (FrmDrawing frame) {
		this.frame = frame;		//omogucili panelu pristup javnom delu klase frame
		setBackground(Color.WHITE);
		addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent me) {
				thisMouseClicked(me); 		//detektovanje kada se klik desio sadrzi i koordinate klika
			}
		});
	...
	public void paint(Graphics g) {
		...
		Iterator<Shape> iterator = shapes.iterator();
		while (iterator.hasNext())
			iterator.next().draw(g);		//dinamicko (kasno) povezivanje
